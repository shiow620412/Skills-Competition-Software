if (!self._FC2COUNTER89418249_0)
{
	var _FC2COUNTER89418249_0 =
	{
		id:89418249,
		graph_img:null,
		show_graph:function(e)
		{
			if (this.graph_img == null )
			{
				...
				img.src = 'http://panel.counter1.fc2.com/popup.php?id=89418249&main=0&lang=0';
		...
		disp_js:function()
		{
			document.write('<script type="text/javascript" language="javascript"'
				+ ' src="http://counter1.fc2.com/counter_js.php?id=89418249&main=0&lang=0'
